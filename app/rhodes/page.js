        ...
        <div className="w-screen min-h-screen bg-gray-100 text-gray-900">
            <div className="relative w-full h-60">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <h2 className="text-4xl font-bold text-white font-playfairDisplay">Discover Rhodes</h2>
                </div>
            </div>
            ...
            <div className="container mx-auto py-10 px-6 md:px-16 space-y-16">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div className="md:w-1/2 md:pl-10 mt-6 md:mt-0">
                        <h3 className="text-2xl font-semibold mb-4 font-playfairDisplay">The Medieval Old Town</h3>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center md:items-start">
                    ...
                    <div className="md:w-1/2 md:pr-10 mt-6 md:mt-0">
                        <h3 className="text-2xl font-semibold mb-4 font-playfairDisplay">Stunning Beaches</h3>
                        <p className="text-lg text-gray-700">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div className="md:w-1/2 md:pl-10 mt-6 md:mt-0">
                        <h3 className="text-2xl font-semibold mb-4 font-playfairDisplay">Lindos and the Acropolis</h3>
                        <p className="text-lg text-gray-700">
